...
export default function Contact() {
  ...
  const storeImages = [
  "/img/lagerfeld-store1.jpg",
  "/img/lagerfeld-store2.jpeg",
  "/img/lagerfeld-store3.webp",
];
  ...
  return (
    ...
    <>
      <Head>
        <title>LAGERFELD Brand – I&A International</title>
...
<div className="w-full h-64 relative overflow-hidden">
  ...
  <div className="relative z-10 flex items-center justify-center h-full text-white px-4 max-w-6xl mx-auto">
    <h2 className="text-3xl md:text-4xl font-bold uppercase mt-[100px]">LAGERFELD Brand</h2>
  </div>
</div>
 ...
 {/* === LAGERFELD Brand Section === */}
<section className="max-w-6xl mx-auto px-4 py-16">
  <div className="text-center mb-10">
    <h2 className="text-3xl md:text-4xl font-semibold mb-4">About LAGERFELD</h2>
    <p className="text-gray-600 max-w-2xl mx-auto">
      LAGERFELD is a fusion of edgy sophistication and visionary fashion. Inspired by the iconic legacy of Karl Lagerfeld, 
      the brand showcases avant-garde aesthetics, refined tailoring, and bold expression. LAGERFELD collections embody a modern 
      take on luxury, empowering individuals to make a distinctive statement with timeless style.
    </p>
  </div>
