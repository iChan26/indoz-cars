...
export default function Contact() {
  ...
  const storeImages = [
  "/img/estee-store1.jpg",
  "/img/estee-store2.png",
  "/img/estee-store3.jpeg",
];
  ...
  return (
    ...
    <>
      <Head>
        <title>ESTÉE Brand – I&A International</title>
...
<div className="w-full h-64 relative overflow-hidden">
  ...
  <div className="relative z-10 flex items-center justify-center h-full text-white px-4 max-w-6xl mx-auto">
    <h2 className="text-3xl md:text-4xl font-bold uppercase mt-[100px]">ESTÉE Brand</h2>
  </div>
</div>
...
<section className="max-w-6xl mx-auto px-4 py-16">
  <div className="text-center mb-10">
    <h2 className="text-3xl md:text-4xl font-semibold mb-4">About ESTÉE</h2>
    <p className="text-gray-600 max-w-2xl mx-auto">
      ESTÉE stands for timeless beauty and graceful sophistication. With a legacy built on elegance, innovation, and refined luxury,
      ESTÉE delivers premium collections that blend classic charm with modern allure. Every piece is crafted to enhance the natural
      confidence and individuality of those who wear it.
    </p>
  </div>
