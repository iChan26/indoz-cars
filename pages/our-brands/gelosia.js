...
export default function Contact() {
  ...
  const storeImages = [
  "/img/gelosia-store1.jpg",
  "/img/gelosia-store2.png",
  "/img/gelosia-store3.png",
];
  ...
  return (
    ...
    <>
      <Head>
        <title>GELOSIA Brand – I&A International</title>
...
<div className="w-full h-64 relative overflow-hidden">
  ...
  <div className="relative z-10 flex items-center justify-center h-full text-white px-4 max-w-6xl mx-auto">
    <h2 className="text-3xl md:text-4xl font-bold uppercase mt-[100px]">GELOSIA Brand</h2>
  </div>
</div>
  ...
  {/* === GELOSIA Brand Section === */}
<section className="max-w-6xl mx-auto px-4 py-16">
  <div className="text-center mb-10">
    <h2 className="text-3xl md:text-4xl font-semibold mb-4">About GELOSIA</h2>
    <p className="text-gray-600 max-w-2xl mx-auto">
      GELOSIA is a celebration of passion, bold design, and radiant elegance. Each collection is a statement of individuality, crafted 
      for those who embrace their emotions and express their identity through distinctive luxury. With daring creativity and timeless 
      sophistication, GELOSIA redefines the art of contemporary jewelry.
    </p>
  </div>
