...
export default function Contact() {
  ...
  const storeImages = [
  "/img/belma-store1.webp",
  "/img/belma-store2.png",
  "/img/belma-store3.png",
];
...
useEffect(() => {
  ...
  return (
    ...
    <>
      <Head>
        <title>Belma Brand – I&A International</title>
...
<div className="w-full h-64 relative overflow-hidden">
  ...
  <div className="relative z-10 flex items-center justify-center h-full text-white px-4 max-w-6xl mx-auto">
    <h2 className="text-3xl md:text-4xl font-bold uppercase mt-[100px]">Belma Brand</h2>
  </div>
</div>
...
<section className="max-w-6xl mx-auto px-4 py-16">
  <div className="text-center mb-10">
    <h2 className="text-3xl md:text-4xl font-semibold mb-4">About Belma</h2>
    <p className="text-gray-600 max-w-2xl mx-auto">
      Belma is the epitome of refined femininity and delicate craftsmanship. Known for its timeless elegance, Belma
      offers an exclusive range of luxury jewelry and accessories designed to elevate every moment. Our legacy is
      rooted in sophistication, innovation, and an unwavering commitment to quality.
    </p>
  </div>
