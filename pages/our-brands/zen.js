...
export default function Contact() {
  ...
  return (
    ...
    <>
      <Head>
        <title>ZEN Brand – I&A International</title>
...
<div className="w-full h-64 relative overflow-hidden">
  ...
  <div className="relative z-10 flex items-center justify-center h-full text-white px-4 max-w-6xl mx-auto">
    <h2 className="text-3xl md:text-4xl font-bold uppercase mt-[100px]">ZEN Brand</h2>
  </div>
</div>
...
<section className="max-w-6xl mx-auto px-4 py-16">
  <div className="text-center mb-10">
    <h2 className="text-3xl md:text-4xl font-semibold mb-4">About ZEN</h2>
    <p className="text-gray-600 max-w-2xl mx-auto">
      ZEN embodies modern sophistication and serene elegance. With a focus on clean lines, minimalist design, and refined detail, 
      ZEN jewelry reflects balance and clarity. Each piece is thoughtfully created to empower those who seek timeless beauty with a 
      contemporary edge.
    </p>
  </div>
