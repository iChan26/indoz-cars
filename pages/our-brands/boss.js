...
export default function Contact() {
  ...
  return (
    ...
    <>
      <Head>
        <title>BOSS Brand – I&A International</title>
...
<div className="w-full h-64 relative overflow-hidden">
  ...
  <div className="relative z-10 flex items-center justify-center h-full text-white px-4 max-w-6xl mx-auto">
    <h2 className="text-3xl md:text-4xl font-bold uppercase mt-[100px]">BOSS Brand</h2>
  </div>
</div>
...
<section className="max-w-6xl mx-auto px-4 py-16">
  <div className="text-center mb-10">
    <h2 className="text-3xl md:text-4xl font-semibold mb-4">About BOSS</h2>
    <p className="text-gray-600 max-w-2xl mx-auto">
      BOSS represents modern luxury with bold sophistication and effortless style. Renowned for its iconic fashion legacy, 
      BOSS blends premium craftsmanship with innovative design. Each collection reflects confidence, precision, and 
      contemporary elegance for those who lead with style and purpose.
    </p>
  </div>
