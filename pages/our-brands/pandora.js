...
export default function Contact() {
  ...
  const storeImages = [
  "/img/pandora-store1.jpg",
  "/img/pandora-store2.jpg",
  "/img/pandora-store3.jpg",
];
  ...
  return (
    ...
    <>
      <Head>
        <title>PANDORA Brand – I&A International</title>
...
<div className="w-full h-64 relative overflow-hidden">
  ...
  <div className="relative z-10 flex items-center justify-center h-full text-white px-4 max-w-6xl mx-auto">
    <h2 className="text-3xl md:text-4xl font-bold uppercase mt-[100px]">PANDORA Brand</h2>
  </div>
</div>
  ...
  <span className="absolute -bottom-1 left-0 h-[1.5px] w-0 bg-black group-hover:w-full transition-all duration-300" />
        ...
        <AnimatePresence initial={false}>
          ...
          {/* === PANDORA Brand Section === */}
<section className="max-w-6xl mx-auto px-4 py-16">
  <div className="text-center mb-10">
    <h2 className="text-3xl md:text-4xl font-semibold mb-4">About PANDORA</h2>
    <p className="text-gray-600 max-w-2xl mx-auto">
      PANDORA is celebrated for its personalized charm jewelry and timeless elegance. Blending hand-finished craftsmanship with 
      contemporary design, PANDORA empowers individuals to express their unique stories and moments through iconic pieces that 
      inspire self-expression and meaningful connections.
    </p>
  </div>
