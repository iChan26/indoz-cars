...
export default function Contact() {
  ...
  const storeImages = [
  "/img/robertobravo-store1.jpg",
  "/img/robertobravo-store2.webp",
  "/img/robertobravo-store3.jpg",
];
  ...
  return (
    ...
    <>
      <Head>
        <title>ROBERTO BRAVO Brand – I&A International</title>
...
<div className="w-full h-64 relative overflow-hidden">
  ...
  <div className="relative z-10 flex items-center justify-center h-full text-white px-4 max-w-6xl mx-auto">
    <h2 className="text-3xl md:text-4xl font-bold uppercase mt-[100px]">ROBERTO BRAVO Brand</h2>
  </div>
</div>
      {/* === Sticky Header === */}
  ...
  <span className="absolute -bottom-1 left-0 h-[1.5px] w-0 bg-black group-hover:w-full transition-all duration-300" />
   ...
   {/* === ROBERTO BRAVO Brand Section === */}
<section className="max-w-6xl mx-auto px-4 py-16">
  <div className="text-center mb-10">
    <h2 className="text-3xl md:text-4xl font-semibold mb-4">About ROBERTO BRAVO</h2>
    <p className="text-gray-600 max-w-2xl mx-auto">
      ROBERTO BRAVO is synonymous with bold creativity and artistic expression in fine jewelry. 
      Renowned for its intricate storytelling and vibrant craftsmanship, the brand merges Italian elegance 
      with daring innovation. Each collection is a masterpiece, designed to inspire individuality and spark imagination.
    </p>
  </div>
      ...
      {storeImages.map((src, index) => (
        <SwiperSlide key={index}>
          <div className="relative w-full h-full">
            <Image
              src={src}
              alt={`ROBERTO BRAVO Store ${index + 1}`}
              fill
